...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemDtoByItemId(long userId, long itemId) {
    ...
    public ResponseEntity<Object> searchItems(String text, Integer from, Integer size) {
        ...
        return get("/search?text={text}&from={from}&size={size}", parameters); // этот метод переопределился, проверить, как работает
    }
